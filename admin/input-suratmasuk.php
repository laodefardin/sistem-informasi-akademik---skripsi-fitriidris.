...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Input Surat Masuk | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                <h4>Input Data Surat Masuk</h4>
                <span>Halaman ini untuk menginput/menambah data surat masuk</span>
              </div>

              <div class="card-block">
                <form class="form-horizontal style-form" action="insert-suratmasuk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
