...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Edit Surat Masuk | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              <div class="card-header">
                ...
                <span>Halaman ini untuk mengedit surat keluar</span>
              </div>

              <div class="card-block">

                <?php
                $query = mysql_query("SELECT * FROM surat_masuk WHERE id_suratmasuk='$_GET[id]'");
                $data  = mysql_fetch_array($query);
                ?>

<form class="form-horizontal style-form" action="update-suratmasuk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
<input type="text" name="id" value="<?= $_GET['id']; ?>" hidden>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                              <div class="col-sm-10">
                                  <input name="keterangan" type="text" id="keterangan" class="form-control" value="<?= $data['keterangan']; ?>" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Surat</label>
                              <div class="col-sm-10">
                                  <input name="date" type="date" id="date" class="form-control" value="<?= $data['tanggal']?>" required/>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              <a href="<?php echo $data['gambar']; ?>" target="_blank"><img src="<?php echo $data['gambar']; ?>" width="60" height="60" class="img-circle" style="border: 3px solid orange;" /></a>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                ...
                                <a href="suratmasuk" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
