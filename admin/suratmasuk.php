          ...
          <div class="card">
            ...
            <div class="card-block table-border-style">
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                <a class="btn btn-primary btn-bordered btn-mini pull-right" href="input-suratmasuk">
                ...
                { ?>
                  <tr>
                    ...
                    <td><center><a class="btn btn-mini btn-primary tooltips" data-placement="bottom" data-original-title="Edit Siswa" href="edit-suratmasuk?hal=edit&id=<?php echo $data['id_suratmasuk'];?>"><span class="icofont-edit"></span></a>
                      <hr /><a class="btn btn-mini btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Siswa" href="hapus-suratmasuk.php?hal=hapus&id=<?php echo $data['id_suratmasuk'];?>"><span class="icofont-trash"></a></center></td></tr>
                       <?php  
                       $no++; 
                     } 
                     ?>
