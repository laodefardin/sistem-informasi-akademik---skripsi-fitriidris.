          ...
          <div class="card">
            ...
            <div class="card-block table-border-style">
              <div class="button-panel" style="padding: 0px 20px 10px 20px;float:left">
                <a class="btn btn-primary btn-bordered btn-mini pull-right" href="input-suratkeluar">
                  <i class="icofont icofont-plus-circle"></i>Tambah</a>
                </div>
                <div class="table-responsive">
                 <?php
                 $query1="select * from surat_keluar";
                ...
                <?php $no = 1;  while($data=mysql_fetch_array($tampil))
                { ?>
                  <tr>
                    <td><?php echo $no ?></td>
                    <td><?= $data['tanggal'] ?></td>
                    ...
                    <td><a href="<?php echo $data['gambar']; ?>" target="_blank"><img src="<?php echo $data['gambar']; ?>" width="60" height="60" class="img-circle" style="border: 3px solid orange;" /></a></td>
                    
                    <td><center><a class="btn btn-mini btn-primary tooltips" data-placement="bottom" data-original-title="Edit" href="edit-suratkeluar?hal=edit&id=<?php echo $data['id_suratkeluar'];?>"><span class="icofont-edit"></span></a>
                      <hr /><a class="btn btn-mini btn-danger tooltips" data-placement="bottom" data-original-title="Hapus" href="hapus-suratkeluar.php?hal=hapus&id=<?php echo $data['id_suratkeluar'];?>"><span class="icofont-trash"></a></center></td></tr>
                       <?php  
                       $no++; 
                     } 
                     ?>
