    ...
    <div class="pcoded-inner-navbar main-menu">
        <div class="">
            <div class="main-menu-header">
                <img class="img-50 img-radius" src="../foto/user.png" alt="">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu ">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="ti-star"></i><b>S</b></span>
                    <span class="pcoded-mtext" data-i18n="nav.subscription.main">Surat</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">
                    <li class="">
                        <a href="suratmasuk">
                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.subscription.bank">Surat Masuk</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class="">
                        <a href="suratkeluar">
                            <span class="pcoded-micon"><i class="icon-pie-chart"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.subscription.paypal">Surat Keluar</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
