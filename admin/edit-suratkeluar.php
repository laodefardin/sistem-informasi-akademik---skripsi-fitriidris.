...
if (empty($_SESSION['username'])){
  ...
  <html lang="id">
  <head>
    <title>Edit Surat Keluar | Si Akademik</title>
          ...
          <div class="page-wrapper" style="padding:1rem">
            ...
            <div class="card total-request-card">
              ...
              <div class="card-block">
                ...
                <?php
                $query = mysql_query("SELECT * FROM surat_keluar WHERE id_suratkeluar='$_GET[id]'");
                $data  = mysql_fetch_array($query);
                ?>

<form class="form-horizontal style-form" action="update-suratkeluar.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
<input type="text" name="id" value="<?= $_GET['id']; ?>" hidden>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                ...
                                <a href="suratkeluar" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
