...
<!--[if lt IE 10]>
  ...
  <meta name="author" content="Nur Idil Fitri Idris">
                ...
                <div class="auth-box">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <img src="./foto/logo1.png" style="height: 100px;" alt="">
                                <!-- <h1 style="font-family: 'Montserrat', sans-serif; font-weight: 800; letter-spacing: -0.05em; margin-bottom: -1px;">Si Akademik</h1> -->
                                <h4 style="font-family: 'Montserrat', sans-serif; font-weight: 500; letter-spacing: -0.05em;">Sistem Informasi Akademik SMA Negeri 4 TAKALAR</h4>
