...
# Filter Data Nilai berdasarkan Combo yang dipilih
    $filterSQL  = "WHERE nilai.kode_guru = '$kodeguru'";
    if(isset($_POST['btnPilih1'])) {
      $filterSQL = " WHERE nilai.kode_guru = '$kodeguru' AND nilai.kode_kelas = '$dataKelas'";
    }
    elseif(isset($_POST['btnPilih2'])) {
      $filterSQL = " WHERE nilai.kode_guru = '$kodeguru' AND nilai.kode_kelas = '$dataKelas' AND nilai.kode_pelajaran = '$dataPelajaran'";
    }
    elseif(isset($_POST['btnPilih3'])) {
      $filterSQL = " WHERE nilai.kode_guru = '$kodeguru' AND nilai.kode_kelas = '$dataKelas' AND nilai.kode_pelajaran = '$dataPelajaran' AND nilai.semester = '$dataSemester'";
    }
    else {
      $filterSQL = "WHERE nilai.kode_guru = '$kodeguru'";
    }
